...
import { useManageMemberInviteSelection } from '../hooks/useManageMemberInviteSelection'
import { SelectedUsersPermissionSet } from './SelectedUsersPermissionSet'
import { UnselectedUserOption } from './UnselectedUserOption'
...
export function InviteWorkspaceMemberDialog({
    ...
    const { data: users = [], isLoading } = useGetInvitableWorkspaceUsers(
        workspaceId,
        debouncedValue,
    )
